...
namespace MVCManukauTech.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.CategoryId = new SelectList(db.Categories.Where(a => a.CategoryName == "Tools"), "CategoryId", "CategoryName");
            return View();
        }
        ...
        public ActionResult Edit(string id)
        {
            ...
            ViewBag.CategoryId = new SelectList(db.Categories.Where(p => p.CategoryName == "Tools"), "CategoryId", "CategoryName", product.CategoryId);
            return View(product);
        }
